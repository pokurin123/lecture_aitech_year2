...
#Main
#任意に入力でスタート地点を変更
input_name = ["武蔵国分寺跡","都立武蔵国分寺公園","お鷹の道・真姿の池湧水群","武蔵国分寺","都立小金井公園","江戸東京たてもの園","けやき公園","昭和記念公園","玉川上水緑道","谷保天満宮"]
#---------------------------------
#---------------------------------
...
for i in input_name:
    print("・" + i)
print("-------------------------\n")
start_point = input("[開始地点を入力]:")
#---------------------------------
#---------------------------------
input_name.remove(str(start_point))
...
for i in input_name:
    print("・" + i)
print("-------------------------\n")
print("[注意]:入力の際はコンマで区切る事")
wanna = input("[目的地を入力]:")
wanna_go = wanna.split(",")
#---------------------------------
#---------------------------------
